...
class RiskChecker:
    ...
    def assess(
        ...
        return RiskAssessment(
            ...
            risk_stage=self._get_risk_stage(risk_level),
    ...
    def _get_risk_stage(self, risk_level: RiskLevel) -> str:
        """Convert technical risk level to the user-facing Korean stage label."""
        # Child-adolescent counseling data is mapped to these stages for reference:
        # 정상군 -> 관심
        # 관찰필요 -> 관심 또는 주의
        # 상담필요 -> 주의
        # 학대의심 -> 주의 또는 위험
