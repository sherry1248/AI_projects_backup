...
class DeepseekClient:
    ...
    def _mock_analyze(self, user_message: str) -> AnalysisResult:
        ...
        elif any(word in message_lower for word in ["anxious", "anxiety", "panic", "worried", "걱정", "초조", "불안"]):
        ...
        elif any(word in message_lower for word in ["depressed", "hopeless", "sad", "empty", "우울", "기운이 없어", "무기력", "외로"]):
