...
class WellnessAutoRegressiveDataset(Dataset):
  ...
  def __init__(self,
               file_path = "/content/drive/MyDrive/final_prj/WEB_Ask_06devbros-main/ai/chatbot/data/wellness_dialog_for_autoregressive.txt",
               n_ctx = 1024
               ):
...
class WellnessTextClassificationDataset(Dataset):
  ...
  def __init__(self,
               file_path = "/content/drive/MyDrive/final_prj/WEB_Ask_06devbros-main/ai/chatbot/data/wellness_data_for_text_classification.txt",
               num_label = 359,
               device = 'cpu',
