## Ex 5-20. QTextEdit.
import sys
sys.path.append('C:\\sqlite\\mysql\\code\\AI\\FINAL_project\\Capstone_2022-main\\Capstone_2022-main\\Demonstration')
from model.load_electra import DialogElectra
...
class MyApp(QWidget):
    ...
    def set_text(self):
        text = self.te.toPlainText()
        prediction = self.kobert.predict(text)
        # print("Prediction:", prediction)
        self.ans_btn.setText(str(prediction))
